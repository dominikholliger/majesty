...
public class GameClient_Controller_Old extends Controller<GameClient_Model, GameClient_View> {
	...
	public GameClient_Controller_Old(GameClient_Model model, GameClient_View view) {
		super(model, view);
