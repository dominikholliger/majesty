...
public class GameBoard implements java.io.Serializable {
	...
	// Letzte Punktevergabe f�r SPieler mit der H�chsten Anzahl Karten Pro Location
	private void finishGame() {
		this.gameEnd = true;
		// H�chste Karte aus allen Locations finden

		for (int i = 0; i < 7; i++) {
			Player highestScorePlayer = null; // unsch�n aber egal
			int tempScore = 0;
		...
		// PUnkteabzug f�r jede Karte im Lazarett
		for (Player p : players) {
